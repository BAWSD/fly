-- ============================================================
-- 航班信息跟踪平台 —— 一体化数据库初始化脚本
-- 用途：新建库 + 新建表 + 插入完整演示数据 + 轨迹数据
-- 执行方式：
--   mysql -u root -p123456 < init-all.sql
-- 或使用 Docker：
--   Get-Content init-all.sql -Encoding UTF8 | docker exec -i flight-mysql mysql -uroot -p123456 --default-character-set=utf8mb4
-- ============================================================
